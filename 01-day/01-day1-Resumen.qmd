...
![Ejemplo de Tripleta](../01-day/fig/tripleta_rdf.png)

Imagen creada por: Ávila Barrientos, Eder, (2020) . [Los Datos enlazados y su uso en bibliotecas](https://ru.iibi.unam.mx/jspui/handle/IIBI_UNAM/56) 
...
![Ejemplo de un grafo](../01-day/fig/rdf2.svg)
Imagen creada por Timothy A. Thompson
...
- [Glosario grupal hecho en el taller](https://bit.ly/glosario_talleres)
